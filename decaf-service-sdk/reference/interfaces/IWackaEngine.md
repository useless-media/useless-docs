...
> **absoluteSeekableRange**: [`SeekableRange`](reference/interfaces/SeekableRange.md) | `undefined`
...
> **activeTracks**: [`ActiveTracks`](reference/interfaces/ActiveTracks.md)

***

### allTracks

> **allTracks**: [`Track`](reference/interfaces/Track.md)[]

***

### audioTracks

> **audioTracks**: [`AudioTrack`](reference/interfaces/AudioTrack.md)[]
...
> **stream**: [`Stream`](reference/interfaces/Stream.md) | `undefined`

***

### textTracks

> **textTracks**: [`TextTrack`](reference/interfaces/TextTrack.md)[]
...
> **videoTracks**: [`VideoTrack`](reference/interfaces/VideoTrack.md)[]
...
> **getPlaybackConfiguration**<`T`>(`playbackEngineType?`): `any`
