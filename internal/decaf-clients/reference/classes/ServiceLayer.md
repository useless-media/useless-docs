...
- [`NoOpServiceLayer`](reference/classes/NoOpServiceLayer.md)
...
[`NoOpServiceLayer`](reference/classes/NoOpServiceLayer.md).[`configuration`](NoOpServiceLayer.md#configuration)
...
[`NoOpServiceLayer`](reference/classes/NoOpServiceLayer.md).[`logger`](NoOpServiceLayer.md#logger)
...
> `abstract` **handleLoad**(`load`): `Promise`<`Load`>
