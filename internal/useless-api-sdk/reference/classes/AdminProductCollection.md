...
- [`UselessApiCollection`](UselessApiCollection.md)<[`Product`](reference/interfaces/Product.md)>

## Constructors

### Constructor

> **new AdminProductCollection**(`configuration`): `AdminProductCollection`
...
> **basePath**: `string` = `'/api/v1/admin/products'`
...
> **name**: `string` = `'AdminProductCollection'`
...
> **create**<`TRequest`>(`body`): `Promise`<[`Product`](reference/interfaces/Product.md) | `undefined`>

#### Type Parameters

##### TRequest

`TRequest` = [`AdminCreateProductDto`](reference/interfaces/AdminCreateProductDto.md)
...
`Promise`<[`Product`](reference/interfaces/Product.md) | `undefined`>
...
`TRequest` = [`AdminQueryProductDto`](reference/interfaces/AdminQueryProductDto.md)
...
`TPaginationResponse` = [`PaginationResponse`](PaginationResponse.md)<[`Product`](reference/interfaces/Product.md)>
...
> **get**(`id`): `Promise`<[`Product`](reference/interfaces/Product.md) | `undefined`>
...
> **update**<`TRequest`>(`id`, `body`): `Promise`<[`Product`](reference/interfaces/Product.md) | `undefined`>

#### Type Parameters

##### TRequest

`TRequest` = [`AdminUpdateProductDto`](reference/interfaces/AdminUpdateProductDto.md)
