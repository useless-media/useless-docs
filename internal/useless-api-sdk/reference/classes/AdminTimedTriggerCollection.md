# AdminTimedTriggerCollection

## Extends

- [`UselessApiCollection`](UselessApiCollection.md)<[`TimedTrigger`](reference/interfaces/TimedTrigger.md)>

## Constructors

### Constructor

> **new AdminTimedTriggerCollection**(`configuration`): `AdminTimedTriggerCollection`
...
> **basePath**: `string` = `'/api/v1/admin/action/timed-triggers'`
...
> **name**: `string` = `'AdminTimedTriggerCollection'`
...
> **create**<`TRequest`>(`body`): `Promise`<[`TimedTrigger`](reference/interfaces/TimedTrigger.md) | `undefined`>

#### Type Parameters

##### TRequest

`TRequest` = [`AdminCreateTimedTriggerDto`](reference/interfaces/AdminCreateTimedTriggerDto.md)
...
`TRequest` = [`AdminQueryTimedTriggerDto`](reference/interfaces/AdminQueryTimedTriggerDto.md)
...
> **update**<`TRequest`>(`id`, `body`): `Promise`<[`TimedTrigger`](reference/interfaces/TimedTrigger.md) | `undefined`>

#### Type Parameters

##### TRequest

`TRequest` = [`AdminUpdateTimedTriggerDto`](reference/interfaces/AdminUpdateTimedTriggerDto.md)
