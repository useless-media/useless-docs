...
> **new NotifyController**(`configuration`): `NotifyController`
...
> **basePath**: `string` = `'/api/v1/action/notify'`
...
`TQuery` *extends* `Partial`<[`NotifyQueryDto`](reference/interfaces/NotifyQueryDto.md)> & `Record`<`string`, `any`> = `Record`<`string`, `any`>
...
`TQuery` *extends* `Partial`<[`NotifyQueryDto`](reference/interfaces/NotifyQueryDto.md)> & `Record`<`string`, `any`> = `any`
