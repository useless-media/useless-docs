...
- [`ReadOnlyUselessApiCollection`](ReadOnlyUselessApiCollection.md)<[`Product`](reference/interfaces/Product.md)>

## Constructors

### Constructor

> **new ProductCollection**(`configuration`): `ProductCollection`
...
> **basePath**: `string` = `'/api/v1/product/products'`
...
`TRequest` = [`QueryProductDto`](reference/interfaces/QueryProductDto.md)
