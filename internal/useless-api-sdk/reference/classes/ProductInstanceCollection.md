...
- [`ReadOnlyUselessApiCollection`](ReadOnlyUselessApiCollection.md)<[`ProductInstance`](reference/interfaces/ProductInstance.md)>

## Constructors

### Constructor

> **new ProductInstanceCollection**(`configuration`): `ProductInstanceCollection`
...
> **basePath**: `string` = `'/api/v1/product/product-instances'`
...
> **name**: `string` = `'ProductInstanceCollection'`
...
`TRequest` = [`QueryProductInstanceDto`](reference/interfaces/QueryProductInstanceDto.md)
