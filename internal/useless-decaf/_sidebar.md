...
* [Reference Documentation](reference/index.md)
  ...
  * [Functions](reference/functions.md)
    ...
    * [firmwareMessageLogger](reference/functions/firmwareMessageLogger.md)
    * [interceptPlatformChannel](reference/functions/interceptPlatformChannel.md)
  * [Interfaces](reference/interfaces.md)
    ...
    * [DeCafSaaSArgs](reference/interfaces/DeCafSaaSArgs.md)
    ...
    * [FirmwareManagerDelegate](reference/interfaces/FirmwareManagerDelegate.md)
    ...
    * [IDeCafCoreDebugConfiguration](reference/interfaces/IDeCafCoreDebugConfiguration.md)
