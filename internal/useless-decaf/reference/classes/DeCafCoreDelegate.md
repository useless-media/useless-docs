...
> **new DeCafCoreDelegate**(): `DeCafCoreDelegate`
...
### handleFirmwareChannelConnected()

> **handleFirmwareChannelConnected**(): `Promise`<`void`>
...
> **handleLoad**(`message`): `Promise`<`void`>
...
> **handleRedirect**(`message`): `Promise`<`void`>
