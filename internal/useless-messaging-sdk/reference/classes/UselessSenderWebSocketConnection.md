# UselessSenderWebSocketConnection<T>
...
`T` *extends* [`UselessSenderWebSocketConnectionEventList`](reference/interfaces/UselessSenderWebSocketConnectionEventList.md) = [`UselessSenderWebSocketConnectionEventList`](../interfaces/UselessSenderWebSocketConnectionEventList.md)

## Constructors

### Constructor

> **new UselessSenderWebSocketConnection**<`T`>(`args`, `emitterArgs?`): `UselessSenderWebSocketConnection`<`T`>
