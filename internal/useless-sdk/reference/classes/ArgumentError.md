...
`T` *extends* [`IArgumentErrorDetails`](reference/interfaces/IArgumentErrorDetails.md) = [`IArgumentErrorDetails`](../interfaces/IArgumentErrorDetails.md)

## Constructors

### Constructor

> **new ArgumentError**<`T`>(`args`): `ArgumentError`<`T`>
