...
`T` *extends* [`ILicenseErrorDetails`](reference/interfaces/ILicenseErrorDetails.md) = [`ILicenseErrorDetails`](../interfaces/ILicenseErrorDetails.md)

## Constructors

### Constructor

> **new LicenseError**<`T`>(`code`, `data`): `LicenseError`<`T`>
...
`Optional`<[`UselessErrorArgs`](reference/interfaces/UselessErrorArgs.md)<`T`>, `"code"`>
