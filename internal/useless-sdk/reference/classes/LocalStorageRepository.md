# LocalStorageRepository<TItem, TPartialItem>
...
> **new LocalStorageRepository**<`TItem`, `TPartialItem`>(`name`, `isItemGuard?`, `namespace?`): `LocalStorageRepository`<`TItem`, `TPartialItem`>
