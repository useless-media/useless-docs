# SessionStorageRepository<TItem, TPartialItem>
...
> **new SessionStorageRepository**<`TItem`, `TPartialItem`>(`name`, `isItemGuard?`, `namespace?`): `SessionStorageRepository`<`TItem`, `TPartialItem`>
