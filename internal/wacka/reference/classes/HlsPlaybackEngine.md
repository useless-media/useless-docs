...
> **new HlsPlaybackEngine**(`args`): `HlsPlaybackEngine`
...
> **tracksIntegration**: `HlsTracksIntegration` | `undefined`
...
> **type**: `Hls` = `PlaybackEngineTypes.Hls`
...
> **getConfiguration**(): `Promise`<`Partial`<`HlsConfig`> | `undefined`>

#### Returns

`Promise`<`Partial`<`HlsConfig`> | `undefined`>
