...
- [`IComponentExtension`](reference/interfaces/IComponentExtension.md)<`ShakaPlaybackEngine`>

## Constructors

### Constructor

> **new ShakaPlaybackEngine**(`args`): `ShakaPlaybackEngine`
...
> **extension**: [`ShakaPlaybackEngineExtension`](reference/classes/ShakaPlaybackEngineExtension.md)

#### Implementation of

[`IComponentExtension`](reference/interfaces/IComponentExtension.md).[`extension`](../interfaces/IComponentExtension.md#extension)
...
> **tracksIntegration**: `ShakaTracksIntegration` | `undefined`
...
> **type**: `Shaka` = `PlaybackEngineTypes.Shaka`
...
> **getConfiguration**(): `Promise`<{ } | `undefined`>
